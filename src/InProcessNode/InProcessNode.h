...
public:
  ...
  virtual void getRandomOutsByAmounts(std::vector<rpc_colored_amount>&& amounts, uint64_t outsCount,
...
private:
  ...
  void getRandomOutsByAmountsAsync(std::vector<rpc_colored_amount>& amounts, uint64_t outsCount,
